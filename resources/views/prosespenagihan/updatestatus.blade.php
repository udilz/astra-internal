    ...
    <div class="row">
                ...
                <div class="card-header pb-0 px-3">
                    <div class="row ">
                        ...
                        <div class=" col-md-6 d-flex justify-content-end align-items-center">
                            ...
                            <small>{{ $prosespenagihan->dataunit->tanggal_faktur }}</small>
                        </div>
                    </div>
                </div>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $prosespenagihan->dataunit->nama_sales }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $prosespenagihan->dataunit->nama_supervisor }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $prosespenagihan->dataunit->nama_customer }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $prosespenagihan->dataunit->no_faktur }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $prosespenagihan->dataunit->alur_proses_penjualan }}</span>
                                </div>
                            </div>
                        </li>
                    </ul>
                        ...
                        <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ $prosespenagihan->dataunit->material_type }}</td>
                                    <td>{{ $prosespenagihan->payment_type }}</td>
                                    <td>{{ $prosespenagihan->dataunit->tanggal_faktur }}</td>
                                    <td>{{ $prosespenagihan->dataunit->warna_plat }}</td>
                                    <td>{{ $prosespenagihan->dataunit->nama_leasing }}</td>
                                    <td>
                                        @if ($prosespenagihan->dokumen)
                                            <span class="badge badge-primary">
                                                <a href="{{ route('download.file', $prosespenagihan->dokumen) }}"
                                                    style="color: #ffffff">{{ $prosespenagihan->dokumen }}</a>
                                            </span>
                                        @else
                                        @endif
        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <ul class="list-group">
                        @foreach ($prosespenagihan->statuses()->orderBy('prosespenagihan_status.tanggal_status_penagihan', 'DESC')->get() as $status)
                            <li class="list-group-item border-0 p-3 mb-2 bg-gray-200 border-radius-lg">
                                ...
                                <div class="header__right col-md-15 d-flex justify-content-end align-items-center">
                                    @if (auth()->user()->level == 'Admin')
                                        <form
                                            action="{{ route('prosespenagihan.delete-status', ['statusid' => $status->id, 'prosespenagihan_no_tagihan' => $prosespenagihan->no_tagihan]) }}">
                                    ...
                                    <a href="#" class="pencil" type="button" data-toggle="modal"
                                        ...
                                        {{ \Carbon\Carbon::parse($status->pivot->tanggal_status_penagihan)->format('d F Y, H:i:s') }}
                                    </a>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/prosespenagihan/updatestatustanggal" method="POST" id="formUpdate">
                        @method('put')
                        @csrf
                        <input type="hidden" name="prosespenagihan_no_tagihan" value="{{ $prosespenagihan->no_tagihan }}">
