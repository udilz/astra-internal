    ...
    <div class="row">
                ...
                <div class="card-header pb-0 px-3">
                    <div class="row ">
                        ...
                        <div class=" col-md-6 d-flex justify-content-end align-items-center">
                            ...
                            <small>{{ $kirimunit->dataunit->tanggal_faktur }}</small>
                        </div>
                    </div>
                </div>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $kirimunit->dataunit->nama_sales }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $kirimunit->dataunit->nama_supervisor }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $kirimunit->dataunit->nama_customer }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $kirimunit->dataunit->no_faktur }}</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-gray-800">{{ $kirimunit->dataunit->alur_proses_penjualan }}</span>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{ $kirimunit->no_rangka }}</td>
                                    <td>{{ $kirimunit->no_mesin }}</td>
                                    <td>{{ $kirimunit->dataunit->material_type }}</td>
                                    <td>{{ $kirimunit->dataunit->tanggal_faktur }}</td>
                                    <td>{{ $kirimunit->dataunit->warna_plat }}</td>
                                    <td>{{ $kirimunit->dataunit->nama_leasing }}</td>
                                    <td>
                                        @if ($kirimunit->dokumen)
                                            <span class="badge badge-primary">
                                                <a href="{{ route('download.file', $kirimunit->dokumen) }}"
                                                    style="color: #ffffff">{{ $kirimunit->dokumen }}</a>
                                            </span>
                                        @else
                                        @endif
        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <ul class="list-group">
                        @foreach ($kirimunit->statuses()->orderBy('kirimunit_status.tanggal_status_kirimunit', 'DESC')->get() as $status)
                            <li class="list-group-item border-0 p-3 mb-2 bg-gray-200 border-radius-lg">
                                ...
                                <div class="header__right col-md-15 d-flex justify-content-end align-items-center">
                                    @if (auth()->user()->level == 'Admin')
                                        <form
                                            action="{{ route('kirimunit.delete-status', ['statusid' => $status->id, 'kirimunit_no_rangka' => $kirimunit->no_rangka]) }}">
                                    ...
                                    <a href="#" class="pencil" type="button" data-toggle="modal"
                                        ...
                                        {{ \Carbon\Carbon::parse($status->pivot->tanggal_status_kirimunit)->format('d F Y, H:i:s') }}
                                    </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/kirimunit/updatestatustanggal" method="POST" id="formUpdate">
                        @method('put')
                        @csrf
                        <input type="hidden" name="kirimunit_no_rangka" value="{{ $kirimunit->no_rangka }}">
